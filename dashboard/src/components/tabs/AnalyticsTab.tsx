              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="acc1">ChatGPT Tài khoản 1 (9322)</option>
                    <option value="acc2">ChatGPT Tài khoản 2 (9342)</option>
                  </select>
                </div>
              </div>
              ...
              <div className="liquid-glass rounded-3xl p-5 relative overflow-hidden">
                ...
                <div className="text-sm font-bold text-slate-800 space-y-1 mt-1">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-600">Acc 1 (9322):</span>
                    <b className="text-violet-700">{analyticsData?.stats.byGpt.acc1.count || 0} lượt</b>
                  </div>
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-600">Acc 2 (9342):</span>
