...
if (-not $Account) {
    ...
    Write-Host "     SETUP TAI KHOAN CHATGPT DANG BAI (3101)     " -ForegroundColor Yellow
    Write-Host "=================================================" -ForegroundColor Cyan
    Write-Host "Chon tai khoan ChatGPT ban muon mo de dang nhap:"
    Write-Host " 1. Tai khoan 1 (Profile: n8n-chatgpt-profile, Port: 9322)"
    Write-Host " 2. Tai khoan 2 (Profile: n8n-chatgpt-profile-2, Port: 9342) [Xen ke/Du phong]"
    Write-Host "================================================="
...
$port = if ($Account -eq 1) { 9322 } else { 9342 }
...
Write-Host "Sau khi dang nhap xong, ban de nguyen cua so nay de server 3101 tu dong tao anh xen ke!" -ForegroundColor Cyan
